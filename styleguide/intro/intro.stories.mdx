...
1. <b> Mobile first</b> We design and code for mobile devices first and make no compromise,
...
2. <b>Smooth but sticky</b> All graphics and interactives have a clear architecture,
   a well-defined flow. Still, people should get stuck in our work. Not because we
   messed up – but because our work has multiple layers. We can define it as 1-1-1
   rule.
