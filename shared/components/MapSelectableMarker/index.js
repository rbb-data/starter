...
export default class MapSelectableMarker extends Component {
  ...
  render () {
    ...
    return <Marker {...markerProps} ref={ref => { this.markerRef = ref }} />
  }
}
