  ...
  return (
    <div className={_.search}>
      ...
      <InfoBox className={_.infoBox}>
        Bei Nutzung der Suchfunktion werden Daten an{' '}
        <a
          target="_blank"
        ...
        übertragen. Weitere Informationen auf der rbb{' '}
        <a
          target="_blank"
          rel="noopener noreferrer"
          href="https://www.rbb-online.de/datenschutz/datenschutzerklaerung.html"
        >
